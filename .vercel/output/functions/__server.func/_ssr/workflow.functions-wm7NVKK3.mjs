...
import { a as objectType, i as numberType, o as requireSupabaseAuth, r as enumType, s as stringType, t as arrayType } from "./types-BIoixYDB.mjs";
import { t as createServerRpc } from "./createServerRpc-BiMAX0JB.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/workflow.functions-wm7NVKK3.js
...
var peTransferSuggestion = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => objectType({
	...
	const { notifyForSuggestion } = await import("./notify.server-C--bwD4b.mjs");
