...
import { a as objectType, o as requireSupabaseAuth, s as stringType } from "./types-Bb_8hVAz.mjs";
import { t as createServerRpc } from "./createServerRpc-BiMAX0JB.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth.functions-CzILjp4B.js
...
async function resolveKnownEmail(rawEmail) {
	...
	const { supabaseAdmin } = await import("./client.server-Dm7_TbUq.mjs");
...
var verifyEmployeeOtp = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { createClient } = await import("./dist-BvSd3M2I.mjs").then((n) => n.a).then((n) => n.n);
