...
//#region node_modules/.nitro/vite/services/ssr/assets/notify.server-DnPdIb7W.js
...
async function sendEmailsToUsers(admin, userIds, opts) {
	...
	const nodemailer = await import("./nodemailer-DCZlGoWD.mjs").then((m) => /* @__PURE__ */ __toESM(m.default, 1)).then((m) => m.default ?? m);
