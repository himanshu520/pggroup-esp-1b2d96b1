...
import { C as isModuleNotFoundError, I as trimPathLeft, L as trimPathRight, T as joinPaths, j as reactUse, x as invariant } from "./useStore-9zLFt3g8.mjs";
import { t as rootRouteId } from "./root-DwT5UJhp.mjs";
import { i as redirect } from "./redirect-SIDaGvS3.mjs";
import { d as useNavigate } from "./button-yJoTZDYV.mjs";
import { $ as useMatch, O as Link } from "./app-shell-uI3AfMIW.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/lazyRouteComponent-BfQsN5oL.js
var BaseRoute = class {
	get to() {
		return this._to;
	}
